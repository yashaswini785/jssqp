...
<div class="w3-sidebar w3-bar-block w3-light-grey w3-card" style="width:300px;">
 ...
 <i class="fa fa-user-circle"style="color:grey;"></i>   <b>  Departments </b>   <i class="fa fa-caret-right"></i></div>
  <div id="demoAcc" class="w3-hide w3-white w3-card-4">
    <a href="http://localhost/dlms/hod/addfaculty.php" class="w3-bar-item w3-button">MCA</a>
        <a href="http://localhost/dlms/hod/managefaculty.php" class="w3-bar-item w3-button">BCA</a>
        <a href="http://localhost/dlms/hod/managefaculty.php" class="w3-bar-item w3-button"  ng-repeat = "member in members" >{{member.firstname}}</a>
  ...
  <a href="http://localhost/jssqp/logout.php" class="w3-bar-item w3-button"><i class="fa fa-sign-out" style="color:grey;"></i>  <b> Sign out</b></a>
</div>
  ...
  <div class = "col-md-6 well" >
    ...
    <form>
      <div class = "form-inline">
        <label>Departmentment Name</label>
        ...
        <button type = "button" class = "btn btn-primary form-control" ng-click = "insertData()"><span class = "glyphicon glyphicon-save"></span>ADD</button>
        <br /><br />
